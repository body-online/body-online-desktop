...
const Head = ({ user }: { user?: ExtendedUser }) => {
  ...
  return (
    <>
      <div className='relative flex justify-center h-[180px] md:h-[250px] overflow-hidden'>
          ...
          <div className="flex-between">
            ...
            <div>
              <p className='text-white text-lg lg:text-2xl'>
                Bienvenido <span className="text-clime font-semibold">{user?.name}</span>
              </p>
              <p
      ...
      <div className="px-default pt-6 -mt-[110px] md:-mt-[180px] z-20 container mb-6">
        <div className="relative min-h-60 card px-4 md:px-5 py-5 md:py-6">
