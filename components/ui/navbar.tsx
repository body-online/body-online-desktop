...
export default function Navbar({ user }: { user?: ExtendedUser }) {
    ...
    return (
        <>
            ...
            {/* navigation */}
            <div className="w-full backdrop-blur-lg z-10 sticky top-0 bg-white/50 dark:bg-transparent">
                    ...
                    <div className="flex items-center pr-4">
                        {navigationItems.map((i, index) => {
                            ...
                            if (user?.type == 'operator' && i.title == 'Inicio') {
                                ...
                                return (
                                    <div key={index} className={`${selected ? ' border-caqua dark:border-clime' : 'border-transparent'} h-12 flex items-center border-t-2`}>
            ...
            >
                {isOpen ? (
                    <motion.div onClick={(e) => e.stopPropagation()}
                        ...
                        bg-white dark:bg-cgray custom-border md:border'
                    >
                        <div className="container h-full flex flex-col">

                            <div className="h-full py-4">
                                <div
                                    className='flex flex-col items-center gap-2 px-3 border custom-border bg-slate-50 dark:bg-clightgray rounded-xl py-4 mx-4'
                                >
