...
const SelectEventType = ({ selectedCattle, isSubmitting, watch, unregister, setValue }:
    ...
    const eventTypes = eventTypesList.map((eventType) => {
        const cattleState = Boolean(selectedCattle.state === 'not_pregnant' as any || !selectedCattle.state) ? 'EMPTY' : selectedCattle.state
        ...
        <div>
            <label htmlFor="eventType">
                ...
                <OptionSelector
                    ...
                    options={eventTypes}
                    setValue={(e: EventSchema['eventType']) => { setValue('eventType', e); }}
                />
