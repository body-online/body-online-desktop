...
import SelectEventCattle from './cattle/select-event-cattle'
...
const EventForm = ({ handleSubmit, register, isSubmitting, errors, reset, watch, setValue, handleCloseEventsModal }: EventFormProps) => {
            ...
            <div className='py-default px-default h-full w-full bg-gradient-to-b dark:from-cgray/50'>
                {isSubmitting ? <LoadingIcon /> :
                    <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-y-4 max-w-2xl mx-auto">
                        {step == 0 ?
                            <>
                                <h3 className='semititle'>Fecha del evento</h3>
                                ...
                                <>
                                    <h3 className='semititle'>Seleccionar individuo</h3>
                                    <div>
                                        <SelectEventCattle
                                            watch={watch}
                                            setValue={setValue}
            ...
            <LayoutBottom>
                <div className='w-full space-y-4 max-w-2xl mx-auto '>
                    ...
                    <div className='flex-between gap-4  items-stretch justify-between w-full'>
                        ...
                        {/* prev */}
                        <button
                            disabled={step != 0 && !watch('eventDate') || isSubmitting}
                            onClick={() => {
                        ...
                        {step < 2 ?
                            <button
                                disabled={(step == 0 && !watch('eventDate')) || (step == 1 && !watch('cattleId')) || (step === 2 && !watch('eventType'))}
                            ...
                            :
                            <button
                                disabled={isSubmitting || !watch('cattleId')}
